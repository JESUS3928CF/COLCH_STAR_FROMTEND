                  ...
                  <div className='modal-body'>
                      ...
                      >
                          ...
                          <div className='col-md-6' name='Publicado'>
                              ...
                              >
                                  <option value={(Tallas.tallas = 'S')}>
                                      {' '}
                                      S{' '}
                                  </option>
                                  <option value={(Tallas.tallas = 'M')}>
                                      {' '}
                                      M{' '}
                                  </option>
                                  <option value={(Tallas.tallas = 'L')}>
                                      {' '}
                                      L{' '}
                                  </option>
                                  <option value={(Tallas.tallas = 'XL')}>
                                      {' '}
                                      XL{' '}
                                  </option>
                                  <option value={(Tallas.tallas = 'Unica')}>
                                      {' '}
                                      Unica{' '}
                                  </option>
                              </select>
